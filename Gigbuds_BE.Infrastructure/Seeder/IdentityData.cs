...
internal static class IdentityData
{
    public static IEnumerable<ApplicationUser> GetUsers()
    {
        List<ApplicationUser> users = new List<ApplicationUser>
        {
            ...
            {
                UserName = "jobseeker1",
                SocialSecurityNumber = "133-456-789",
            ...
            new ApplicationUser
            {
                ...
                SocialSecurityNumber = "143-456-789",
            ...
            new ApplicationUser
            {
                ...
                SocialSecurityNumber = "153-456-789",
            ...
            {
                UserName = "employer2",
                NormalizedUserName = "EMPLOYER2",
                Email = "employer2@example.com",
                SocialSecurityNumber = "163-456-789",
                NormalizedEmail = "EMPLOYER2@EXAMPLE.COM",
                FirstName = "Employer2",
                LastName = "Two",
                Password = "Password1!",
